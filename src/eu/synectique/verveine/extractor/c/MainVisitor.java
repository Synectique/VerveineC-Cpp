...
public class MainVisitor extends VerveineVisitor {
	...
	public MainVisitor(CppDictionary dico) {
		super(dico);
	...
	public int visit(IASTDeclarator node) {
		traceup("IASTDeclarator "+node.getName());
	...
	public int leave(IASTDeclarator node) {
		...
		tracedown("IASTDeclarator "+node.getName());
		return super.leave(node);
	}
	...
	@Override
 	public int leave(IASTParameterDeclaration node) {
		tracedown("IASTParameterDeclaration ");
		return super.leave(node);
	}
	...
	public int visit(ICPPASTBaseSpecifier node) {
		traceup("ICPPASTBaseSpecifier "+node.getName());
		return super.visit(node);
	}
	...
	public void visit(IASTFunctionDeclarator node) {
		...
		if (bnd != null) {
			Method fmx = dico.ensureFamixMethod(bnd, nodeName.toString(), /*signature*/nodeName.toString()+"(", /*ret.type*/null, context.topType(), /*persitIt*/true);
